...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "FREQUENTIS") |
| group        | string   | Parent company group (e.g. "Frequentis Group") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/BalaciSofia/frequentis-romania-srl-nodejs-scraper/master/.github/workflows/scrape.yml`)
