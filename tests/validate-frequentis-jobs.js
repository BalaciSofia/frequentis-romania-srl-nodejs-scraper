/**
 * FREQUENTIS Job Validator - Check and remove expired jobs
 *
 * Validates all FREQUENTIS jobs from peviitor API and deletes expired (404) ones from SOLR.
 * Run: node tests/validate-frequentis-jobs.js
 */
...
async function main(args) {
  ...
  console.log("FREQUENTIS Job Validator");
  console.log("=".repeat(50));
